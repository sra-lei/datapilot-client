...
export declare function getObjectField(object: unknown, field: Field, get?: GetField, isArray?: IsArray): any;
export declare function createGetter<T extends GetField>(get: T, isArray?: IsArray): (object: Parameters<T>[0], field: Parameters<T>[1]) => any;
