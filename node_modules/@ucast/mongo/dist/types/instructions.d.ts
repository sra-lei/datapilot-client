...
export declare const $or: CompoundInstruction<((import("./types").MongoQueryFieldOperators<any> & import("./types").MongoQueryTopLevelOperators<any>) | ({
    [x: string]: any;
...
export declare const $gt: FieldInstruction<Comparable, FieldParsingContext>;
export declare const $lt: FieldInstruction<Comparable, FieldParsingContext>;
export declare const $lte: FieldInstruction<Comparable, FieldParsingContext>;
